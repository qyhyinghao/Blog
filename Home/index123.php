...
<header class="am-topbar header">
  ...
  <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
    ...
    <div class=" am-topbar-left am-form-inline am-topbar-right" role="search" >
      <ul class="am-nav am-nav-pills am-topbar-nav hw-menu" id="nav">
	 ...
	 <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{}' >
      ...
      <?php 
        if(!empty($pics)){
          ...
          foreach($pics as $k => $v){
      ?>
        <li><img src="../Public/upload/<?php echo $v['pic_url'] ?>"/></li>
      <?php
            }
        }
      ?>
...
<script type="text/html" id="navTemplate">
    ...
    <li ><a href="../Home/{{value.nav_url}}">{{value.nav_name}}</a></li>
    {{/each}}
...
<script type="text/html" id="picTemplate">
      ...
      {{each result as value}}
      <li><img src="../Public/upload/{{value.pic_url}}"/></li>
      {{/each}}
  ...
  $(function(){
      ...
      $.ajax({
        ...
        success:function(msg){       
          ...
          $("#nav").html(html);
          $("#nav").find("li:eq(0)").addClass("hw-menu-active");
        }
      });

      // $.ajax({
      //     url:'../Home/php/indexPic.php',
      //     dataType:'json',
      //   success:function(msg){       
      //     var msg = msg;
      //     var data = {};
      //     data.result = msg;
      //     console.log(data);
      //     var html = template('picTemplate',data);
      //     $("#slider").append(html);
      //   }
      // });
  })
